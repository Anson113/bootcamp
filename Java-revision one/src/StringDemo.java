...
public class StringDemo {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(s2);// s2 is an object refernce to remain the way to find the object.

    StringBuilder sb = new StringBuilder("hello");
    sb.append("world"); // You don't have to "save" the address of sb. because you alreay changd the value stored.
